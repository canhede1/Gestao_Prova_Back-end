...
router.get('/listarCategoriaProva', (req, res)=>{
...
router.get('/listarCategoriaProva/:id',(req, res)=>{
...
router.post('/inserirCategoriaProva', (req, res)=>{
...
router.put('/alterarCategoriaProva', (req, res)=>{
...
router.delete('/excluirCategoriaProva/:id', (req, res)=>{
